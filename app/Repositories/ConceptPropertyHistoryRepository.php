...
use App\Entities\ConceptPropertyHistory;
use Schema;
...
class ConceptPropertyHistoryRepository extends BaseRepository implements IConceptPropertyHistoryRepository
{
    ...
    **/
    ...
    {
      return ConceptPropertyHistory::class;
    }
